<form action="<?= base_url('membership/simpanmembership'); ?>" method="post" class="formMembership">
    <div class="mb-3 form-group">
        <input type="text" class="form-control" name="namalengkap" placeholder="Nama Lengkap">
    </div>
    <div class="mb-3 form-group">
        <input type="text" class="form-control" name="alamatlengkap" placeholder="Alamat Lengkap">
    </div>
    <div class="mb-3 form-group">
        <input type="text" class="form-control" name="nohp" placeholder="Telepon">
    </div>
    <div class="mb-3 form-group">
        <input type="text" class="form-control" name="tgl_lahir" placeholder="Tempat Tanggal Lahir">
    </div>
    <div class="mb-3 form-group">
        <input type="text" class="form-control" name="bakery" placeholder="Bakery">
    </div>
    <div class="mb-3">
