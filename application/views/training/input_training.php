<form action="<?= base_url('training/simpantraining'); ?>" method="post" class="formTraining">
    <div class="mb-3 form-group">
        <input type="text" class="form-control" name="namatraining" placeholder="Nama Training">
    </div>
    <div class="mb-3 form-group">
        <input type="date" class="form-control" name="tanggaltraining" placeholder="Tanggal Training">
    </div>
    <div class="mb-3 form-group">
    ...
    $('.formTraining').bootstrapValidator({
        fields: {
            namatraining: {
                ...
                validators: {
                    notEmpty: {
                        message: ' Nama trainig harus Diisi!'
                    }
                }
            },
            tanggaltraining: {
