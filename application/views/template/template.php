...
<head>
    ...
    <!-- CSS files -->
    <link href=" <?= base_url(); ?>assets/dist/libs/jqvmap/dist/jqvmap.min.css" rel="stylesheet" type="text/css" />
    <link href=" <?= base_url(); ?>assets/dist/css/tabler.min.css" rel="stylesheet" type="text/css" />
    <link href=" <?= base_url(); ?>assets/dist/css/tabler-flags.min.css" rel="stylesheet" type="text/css" />
    <link href=" <?= base_url(); ?>assets/dist/css/tabler-payments.min.css" rel="stylesheet" type="text/css" />
    <link href=" <?= base_url(); ?>assets/dist/css/tabler-vendors.min.css" rel="stylesheet" type="text/css" />
    ...
    <link href="<?= base_url(); ?>assets/dist/css/all.min.css" rel="stylesheet" type="text/css">
    ...
    .table table-striped table-bordered text-center dataTableno-footer {
        font-color: white;
        text-align: center;
    }
...
<body class="antialiased">
    <aside class="navbar navbar-vertical navbar-expand-lg navbar-dark">
        <div class="container">
            ...
            <a href=" <?= base_url(); ?>dashboard" class="navbar-brand navbar-brand-autodark">
                HR SYSTEM
            </a>
                ...
                <ul class="navbar-nav pt-lg-3">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href=" <?= base_url(); ?>training">
                                        Training Record
                                    </a>
                                </div>
                            </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href=" <?= base_url(); ?>membership">
                                        Membership
                                    </a>
                                </div>
                            </div>
